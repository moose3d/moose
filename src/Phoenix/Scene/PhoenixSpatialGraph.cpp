...
/////////////////////////////////////////////////////////////////
size_t
Phoenix::Scene::CSpatialGraph::CollectObjects( const Phoenix::Graphics::CFrustum &frustum, std::list<CGameObject *> & list, Phoenix::Core::TAG tag, Phoenix::Core::CTagged::TagCompare compare ) const
{
