...
/////////////////////////////////////////////////////////////////
void
Phoenix::Graphics::CFrameBufferObject::Apply()
{
...
/////////////////////////////////////////////////////////////////
GLuint &
Phoenix::Graphics::CFrameBufferObject::GetColorBufferId()
{
    return m_nColorBufferId;
}
/////////////////////////////////////////////////////////////////
const GLuint &
Phoenix::Graphics::CFrameBufferObject::GetColorBufferId() const
{
    return m_nColorBufferId;
}
/////////////////////////////////////////////////////////////////
GLuint &
Phoenix::Graphics::CFrameBufferObject::GetStencilBufferId()
{
    return m_nStencilBufferId;
}
/////////////////////////////////////////////////////////////////
const GLuint &
Phoenix::Graphics::CFrameBufferObject::GetStencilBufferId() const
{
    return m_nStencilBufferId;
}
/////////////////////////////////////////////////////////////////
const Phoenix::Default::TEXTURE_HANDLE &
...
/////////////////////////////////////////////////////////////////
bool
Phoenix::Graphics::CFrameBufferObject::Validate()
{
...
////////////////////////////////////////////////////////////////////////////////
bool
Phoenix::Graphics::CFrameBufferObject::AttachBuffer( int iBufferFlags, GLenum type, 
...
////////////////////////////////////////////////////////////////////////////////
bool
Phoenix::Graphics::CFrameBufferObject::AttachTexture( const Phoenix::Default::TEXTURE_HANDLE & hTexture, unsigned int nColorBuffer )
{
#if defined(PHOENIX_APPLE_IPHONE)
