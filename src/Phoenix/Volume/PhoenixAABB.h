#ifndef __PHOENIXAABB_H__
#define __PHOENIXAABB_H__
///////////////////////////////////////////////////////////////////////////////
...
namespace Phoenix
{
  namespace Volume
  {
    ...
    {
    private:
      Phoenix::Math::CVector3<float> m_vMin;
      Phoenix::Math::CVector3<float> m_vMax;
    public:
      ////////////////////
      ...
      CAxisAlignedBox( const Phoenix::Math::CVector3<float> &vCenter,
		       float fWidth, float fHeight,  float fLength );
      ////////////////////
      /// \returns Corner point with smallest coordinate values.
      const Phoenix::Math::CVector3<float> & GetMin() const;
      /// \returns Corner point with greatest coordinate values.
      const Phoenix::Math::CVector3<float> & GetMax() const;
    }; // AABB
    ////////////////////
