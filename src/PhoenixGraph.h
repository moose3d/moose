...
/////////////////////////////////////////////////////////////////
template<typename R>
CGraphNode<R>::CGraphNode( const CGraphNode &Node) 
{
...
template<typename R>
void
CGraphNode<R>::SetVisited(char bFlag )
{
  m_bVisited = bFlag;
}
/////////////////////////////////////////////////////////////////
...
template<typename R>
void
CGraphNode<R>::SetCulled( char bState )
{
  m_bCulled = bState;
}
/////////////////////////////////////////////////////////////////
...
template<typename R>
R
CGraphNode<R>::GetType()
{
  return m_iType;
}
/////////////////////////////////////////////////////////////////
template<typename R>
std::list<CGraphEdge<R> *> &
CGraphNode<R>::GetLeavingEdges()
{
  return m_lstLeaving;
}
/////////////////////////////////////////////////////////////////
...
template<typename R>
void 
CGraphNode<R>::SetName( const char *szName )
{
...
template<typename R>
void 
CGraphNode<R>::SetChanged( char bFlag )
{
  m_bChanged = bFlag;
}
/////////////////////////////////////////////////////////////////
...
template<typename R>
int 
CGraphNode<R>::AddEdge( CGraphNode<R> *pTo )
{
...
template<typename R>
int 
CGraphNode<R>::DeleteEdgeTo( CGraphNode<R> *pTo )
{
...
template<typename R>
void 
CGraphNode<R>::RemoveLeavingEdges()
{
...
template<typename R>
void 
CGraphNode<R>::RemoveArrivingEdges()
{
...
template<typename R>
void
CGraphNode<R>::SetColor( int iColor )
{
  m_iColor = iColor;
}
/////////////////////////////////////////////////////////////////
...
template<typename R>
void 
CGraph<R>::DeleteNode( CGraphNode< R> *pNode )
{
  ...
  {
    CWARN( "Node " << pNode << " (" << pNode->GetName() << ") " 
...
template<typename R>
int 
CGraph<R>::AddEdge( CGraphNode<R> *pNodeFrom, CGraphNode<R> *pNodeTo )
{
  if ( pNodeFrom == NULL )
  {
    CERR( "FromNode is NULL" );
    return 1;
  }
  ...
  {
    CERR( "Nodes belong to different graphs!" );
    return 1;
  }
...
template<typename R>
void
CGraph<R>::DeleteEdge( CGraphEdge<R> *pEdge)
{
...
template<typename R>
void
CGraph<R>::RemoveNodes()
{
  CDEBUG( "removing nodes (" << m_lstNodes.size() << ")...");
...
template<typename R>
void
CGraph<R>::RemoveEdges()
{
  CDEBUG( "removing edges (" << m_lstEdges.size() << ")...");
...
template<typename R>
void 
CGraph<R>::RemoveLeavingEdgesFrom( CGraphNode<R> *pNode )
{
...
template<typename R>
void 
CGraph<R>::RemoveArrivingEdgesFrom( CGraphNode<R> *pNode )
{
  typename std::list<CGraphEdge<R> *>::iterator it;
...
template<typename R>
CGraphNode<R> * 
CGraph<R>::SeekNodeByNameAndType( const char *szName, 
				     const R iType )
{
  typename std::list< CGraphNode<R> *>::iterator it;
  it = m_lstNodes.begin();
...
template <typename R>
void  
CGraph<R>::SetColor( unsigned int nColor )
{
  typename std::list<CGraphNode<R> *>::iterator it = m_lstNodes.begin();
...
namespace Graph {
  template <typename R>
  CGraphNode<R> * SeekNextWithType( CGraphNode<R> *pStartNode, R type )
  {
  ...
  void  
  TravelDF( CGraphNode<R> *pStartNode, TravellerType * pTraveller )
  {
