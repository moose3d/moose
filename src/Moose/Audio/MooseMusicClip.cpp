...
//////////////////////////////////////////////////////////////
bool
Moose::Sound::CMusicClip::IsPaused() const
{
    return m_bPaused;
}
//////////////////////////////////////////////////////////////
bool
Moose::Sound::CMusicClip::IsRunning() const
{
    return m_bRunning;
}
//////////////////////////////////////////////////////////////
Moose::Sound::CMusicClip::CMusicClip() : m_pData(NULL), m_bRunning(false), m_bPaused(false), m_bHasThread(false)
{
    
}//////////////////////////////////////////////////////////////
Moose::Sound::CMusicClip::~CMusicClip()
{
    if ( m_bHasThread )
    {
        void * status;
...
/////////////////////////////////////////////////////////////
bool
Moose::Sound::CMusicClip::Load( const char *szFilename )
{
    if ( m_pData ) {
