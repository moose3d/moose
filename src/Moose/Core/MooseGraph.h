...
#ifndef __MooseGraph_h__
#define __MooseGraph_h__
/////////////////////////////////////////////////////////////////
#include <stack>
#include <list>
#include <queue>
...
template <class NODE_TYPE, class TRAVELLER_TYPE>
void
Moose::Core::TravelDF( NODE_TYPE *pStartNode, TRAVELLER_TYPE * pTraveller )
{
...
template<class NODE_TYPE>
void
Moose::Core::TravelDF( NODE_TYPE *pStartNode )
{
...
/* GRAPH_EDGE * */
/* Moose::Core::TGraph<NODE_TYPE>::AddEdge( NODE_TYPE *pNodeFrom, NODE_TYPE *pNodeTo ) */
/* { */
/*   if ( pNodeFrom == NULL ) */
/*   { */
/*     std::cerr << "FromNode is NULL" << std::endl; */
