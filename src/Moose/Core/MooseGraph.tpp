...
Moose::Core::TGraphEdge<NODE_TYPE>::TGraphEdge( NODE_TYPE *pFrom, NODE_TYPE *pTo )
{
  m_pFrom = pFrom;
  m_pTo   = pTo;
...
template<class NODE_TYPE>
void 
Moose::Core::TGraph<NODE_TYPE>::DeleteNode( NODE_TYPE *pNode )
{
	delete pNode;
...
template<class NODE_TYPE>
void
Moose::Core::TGraph<NODE_TYPE>::DeleteEdge( Moose::Core::TGraphEdge<NODE_TYPE> *pEdge)
{
...
template<class NODE_TYPE>
void
Moose::Core::TGraph<NODE_TYPE>::RemoveNodes()
{
...
template<class NODE_TYPE>
void
Moose::Core::TGraph<NODE_TYPE>::RemoveEdges()
{
...
template<class NODE_TYPE>
void 
Moose::Core::TGraph<NODE_TYPE>::RemoveLeavingEdgesFrom( NODE_TYPE *pNode )
{
  typename EdgeListType::iterator it;
...
template<class NODE_TYPE>
void 
Moose::Core::TGraph<NODE_TYPE>::RemoveArrivingEdgesFrom( NODE_TYPE *pNode )
{
  typename EdgeListType::iterator it;
...
// template<class NODE_TYPE>
// void
// Moose::Core::TGraph<NODE_TYPE>::SetNodesUnvisited( )
// {
...
// template<class NODE_TYPE>
// void
// Moose::Core::TGraph<NODE_TYPE>::SetEdgesUntraversed( )
// {
...
template<class NODE_TYPE>
void  
Moose::Core::TGraph<NODE_TYPE>::SetColor( unsigned int nColor )
{
  typename NodeListType::iterator it = m_lstNodes.begin();
...
template<class NODE_TYPE>
void
Moose::Core::TGraph<NODE_TYPE>::RegisterNode( NODE_TYPE *pNode )
{
...
/////////////////////////////////////////////////////////////////
template<class NODE_TYPE>
Moose::Core::TGraphNode<NODE_TYPE>::~TGraphNode()
{
...
template<class NODE_TYPE>
Moose::Core::TGraph<NODE_TYPE> *
Moose::Core::TGraphNode<NODE_TYPE>::GetGraph()
{
  return m_pGraph;
}
/////////////////////////////////////////////////////////////////
template<class NODE_TYPE>
EdgeListType &
Moose::Core::TGraphNode<NODE_TYPE>::GetLeavingEdges()
{
  return m_lstLeaving;
}
/////////////////////////////////////////////////////////////////
template<class NODE_TYPE>
EdgeListType &
Moose::Core::TGraphNode<NODE_TYPE>::GetArrivingEdges()
{
...
template<class NODE_TYPE>
int
Moose::Core::TGraphNode<NODE_TYPE>::HasLeavingEdges()
{
...
template<class NODE_TYPE>
int
Moose::Core::TGraphNode<NODE_TYPE>::HasArrivingEdges()
{
...
template<class NODE_TYPE>
bool
Moose::Core::TGraphNode<NODE_TYPE>::DeleteEdgeTo( NODE_TYPE *pTo )
{
...
template<class NODE_TYPE>
void
Moose::Core::TGraphNode<NODE_TYPE>::DeleteAllEdgesTo( NODE_TYPE *pTo )
{
...
template<class NODE_TYPE>
void 
Moose::Core::TGraphNode<NODE_TYPE>::RemoveLeavingEdges()
{
...
template<class NODE_TYPE>
void 
Moose::Core::TGraphNode<NODE_TYPE>::RemoveArrivingEdges()
{
...
template<class NODE_TYPE>
void
Moose::Core::TGraphNode<NODE_TYPE>::SetColor( int iColor )
{
  m_iColor = iColor;
}
/////////////////////////////////////////////////////////////////
template<class NODE_TYPE>
int 
Moose::Core::TGraphNode<NODE_TYPE>::GetColor()
{
  return m_iColor;
}
/////////////////////////////////////////////////////////////////
template<class NODE_TYPE>
size_t
Moose::Core::TGraphNode<NODE_TYPE>::GetInDegree()
{
...
template<class NODE_TYPE>
size_t
Moose::Core::TGraphNode<NODE_TYPE>::GetOutDegree()
{
