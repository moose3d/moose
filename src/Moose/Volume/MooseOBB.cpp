...
/////////////////////////////////////////////////////////////////
void
Moose::Volume::COrientedBox::SetOrientation(const CVector3<float> &vUp,
...
/////////////////////////////////////////////////////////////////
/*void
Moose::Volume::COrientedBox::CalculatePlanes()
{
...
/////////////////////////////////////////////////////////////////
/*void
Moose::Volume::COrientedBox::CalculateCorners()
{
  CVector3<float> vTmp;
...
/////////////////////////////////////////////////////////////////
CVector3<float>
Moose::Volume::COrientedBox::GetCorner( BBOX_CORNER_TYPE tCorner ) const
{
...
///////////////////////////////////////////////////////////////////////////////
/*
 obOrientedBox[Moose::Volume::FRONT].SetNormal(-R);   				\
 obOrientedBox[Moose::Volume::FRONT][3]  = rmax;					\
 obOrientedBox[Moose::Volume::BACK].SetNormal(R);       				\
 obOrientedBox[Moose::Volume::BACK][3] = -rmin;				\
 obOrientedBox[Moose::Volume::RIGHT].SetNormal(-S);			\
 obOrientedBox[Moose::Volume::RIGHT][3] = smax;					\
 obOrientedBox[Moose::Volume::LEFT].SetNormal(S);    				\
 obOrientedBox[Moose::Volume::LEFT][3] = -smin;					\
 obOrientedBox[Moose::Volume::TOP].SetNormal(-T);    				\
 obOrientedBox[Moose::Volume::TOP][3] = tmax;					\
 obOrientedBox[Moose::Volume::BOTTOM].SetNormal(T);					\
 obOrientedBox[Moose::Volume::BOTTOM][3] = -tmin;    				\
...
Moose::Volume::CalculateOrientedBoundingBox( const Moose::Graphics::CVertexDescriptor &rVertices )
{
  /////////////////////////////////////////////////////////////////
  float fMaxR = 0.0f;
  float fMinR = 0.0f;
...
/////////////////////////////////////////////////////////////////
COrientedBox
Moose::Volume::MergeOrientedBoxes( const Moose::Volume::COrientedBox &obOne, const Moose::Volume::COrientedBox &obTwo )
{
...
///////////////////////////////////////////////////////////////////////////////
void
Moose::Volume::COrientedBox::Transform( const Moose::Math::CTransform & transf )
{
...
#ifndef SWIG
void
Moose::Volume::operator*=( Moose::Volume::COrientedBox & box, const Moose::Math::CTransform & transf )
{
