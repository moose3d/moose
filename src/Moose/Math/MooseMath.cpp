...
/////////////////////////////////////////////////////////////////
void
Moose::Math::QuaternionToMatrix( const CQuaternion &qQuat, CMatrix4x4<float> &mMatrix )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::Slerp( CQuaternion qFrom, CQuaternion qTo, float fInterpolation, CQuaternion &result )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationMatrix(const CVector3<float> & vAxis, float fRadians, CMatrix4x4<float> &result)
{
  RotationMatrix( vAxis[0], vAxis[1], vAxis[2], fRadians, result );
}
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationMatrix(float fX, float fY, float fZ, float fRadians, CMatrix4x4<float> &mResult)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationMatrix( const CVector3<float> &vRadians, CMatrix4x4<float> & result)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationMatrix(float fX, float fY, float fZ, CMatrix4x4<float> & mResult )
{
  ...
  Moose::Math::QuaternionToMatrix(qR,mResult);
...
// ---------------------------------------------------------------------------------
void
Moose::Math::GetTBNMatrix( CVector3<float> vPoint0, CVector3<float> vPoint1, CVector3<float> vPoint2,
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::CalculateTangentArray( const CVertexDescriptor &vertices,
...
/////////////////////////////////////////////////////////////////
float
Moose::Math::Det(const CMatrix4x4<float> & mMatrix)
{
  float fDet = 0.0;
  CMatrix3x3<float> m;
...
float
Moose::Math::Det(const CMatrix3x3<float> & mMatrix)
{
  float fDet = 0.0;
  CMatrix2x2<float> m;
  RemoveRowAndColumn(mMatrix, 1,1,m); fDet += mMatrix.At(0,0) * Det(m);
...
float
Moose::Math::Det(const CMatrix2x2<float> & mMatrix)
{
  return mMatrix.At(0,0) * mMatrix.At(1,1) - mMatrix.At(0,1) * mMatrix.At(1,0);
}
/////////////////////////////////////////////////////////////////
void
Moose::Math::CovarianceMatrix( const CVertexDescriptor &vertexDescriptor, CMatrix3x3<float> & mCovariance)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::CovarianceMatrix(  const CVertexDescriptor &vertexDescriptor, const CIndexArray &indices, CMatrix3x3<float> & mCovariance )
{
...
void
Moose::Math::CalculateEigensystem( CMatrix3x3<float> &mMatrix, float &fLambda1, float &fLambda2, float &fLambda3, CMatrix3x3<float> &mRes)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::SetRowVector(CMatrix3x3<float> &mMatrix, unsigned int iRow, const CVector3<float> & vVector)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::SetColumnVector( CMatrix3x3<float> &mMatrix, unsigned int iCol, const CVector3<float> & vVector)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::GetRowVector( const CMatrix3x3<float> & mMatrix, unsigned int iRow, CVector3<float> & result)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::GetColumnVector(const CMatrix3x3<float> & mMatrix, unsigned int iCol, CVector3<float> & result )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::Translate(const CVector3<float> & v, const CMatrix4x4<float> & m, CVector3<float> & result)
{
  result[0] = v[0]+m(0,3);
  result[1] = v[1]+m(1,3);
  result[2] = v[2]+m(2,3);
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::TranslateInverse(const CVector3<float> & v, const CMatrix4x4<float> & m, CVector3<float> & result)
{
  result[0] = v[0]-m(0,3);
  result[1] = v[1]-m(1,3);
  result[2] = v[2]-m(2,3);
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::Rotate( const CVector3<float> & v, const CMatrix4x4<float> &m, CVector3<float> & result)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::Transform( const CVector3<float> &v, const CMatrix4x4<float> &m, CVector3<float> & result)
{
#define T_X    v[0]
#define T_Y    v[1]
#define T_Z    v[2]
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationMatrixToQuaternion( const CMatrix4x4<float> &mMatrix, CQuaternion & qRetval )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotateVector( const CQuaternion &qRotation, CVector3<float> &vVector)
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::QuaternionToRotationAxisAndAngle( const CQuaternion &qQuat,
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RemoveRowAndColumn( const CMatrix3x3<float> & mMatrix,
				   unsigned int iRowSkip,
				   unsigned int iColSkip,
...
/////////////////////////////////////////////////////////////////
int
Moose::Math::InverseMatrix( CMatrix2x2<float> mOrig, CMatrix2x2<float> &mInverse)
{
#define MATRIX_NOT_INVERTIBLE 1
#define MATRIX_INVERTIBLE     0
...
/////////////////////////////////////////////////////////////////
int
Moose::Math::InverseMatrix( CMatrix3x3<float> mOrig, CMatrix3x3<float> &mInverse)
{
...
/////////////////////////////////////////////////////////////////
int
Moose::Math::InverseMatrix( CMatrix4x4<float> mOrig, CMatrix4x4<float> &mInverse)
{
  mInverse.IdentityMatrix();
  unsigned int iRow, iCol, iPivot;
  float fScale, fMultValue;
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::RotationArc( CVector3<float> v0, CVector3<float> v1, Moose::Math::CQuaternion & result)
{
  v0.Normalize();
  v1.Normalize();
...
/////////////////////////////////////////////////////////////////
float
Moose::Math::AngleBetweenVectors( const CVector3<float> &vVect1, const CVector3<float> &vVect2)
{
...
/////////////////////////////////////////////////////////////////
Moose::Math::CVector4<float>
Moose::Math::operator*( const CMatrix4x4<float> &mMatrix, const CVector4<float> &vVector )
{
...
Moose::Math::operator*( const CMatrix3x3<float> &mMatrix, const CVector3<float> &vVector )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Math::OrientedBoxAxisToRotationMatrix ( const Moose::Volume::COrientedBox &ob, Moose::Math::CMatrix4x4<float> & matrix  )
{
