...
#ifndef __MooseMatrix4x4_h__
#define __MooseMatrix4x4_h__
#include <iostream>
...
namespace Moose 
{
  namespace Math 
  {
    ...
    class MOOSE_API CMatrix4x4 
    {
    public:
      static const CMatrix4x4<TYPE> Zero;
      static const CMatrix4x4<TYPE> Identity;
    protected:
      TYPE m_aValues[16];
    public:
      ////////////////////
