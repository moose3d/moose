...
/////////////////////////////////////////////////////////////////
MOOSE_API int
Moose::Collision::CapsuleIntersectsPlane( const Moose::Math::CPlane & plane,
                                            const Moose::Volume::CCapsule & capsule )
{
  ...
  fDistanceOne = vNormal.Dot( capsule.GetStart() ) + plane[3];
  fDistanceTwo = vNormal.Dot( capsule.GetEnd() ) + plane[3];

  float fDistanceSqr = fDistanceOne * fDistanceTwo;
  if ( fDistanceSqr <= 0.0f ) return 0; // intersects
  else
  {
      CVector3<float> vDir = capsule.GetDirection();
      vDir.Normalize();
      float fDenominator = vNormal.Dot(vDir);

      // if capsule is parallel to plane (or close enough)
      if ( TOO_CLOSE_TO_ZERO(fDenominator ))
      {
          if ( fDistanceOne <= capsule.GetRadius() ) return 0; // intersects
          else if ( fDistanceOne < -capsule.GetRadius() ) return -1; // behind plane
          else return 1; // in front of plane
      }
      else
      {
          if ( fDistanceOne < -capsule.GetRadius() && fDistanceTwo < -capsule.GetRadius() ) return -1; // behind plane
          else if ( fDistanceOne > capsule.GetRadius() && fDistanceTwo > capsule.GetRadius() ) return 1; // in front of plane
...
Moose::Collision::LineSegmentIntersectsPlane( const CPlane &plane,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::RayIntersectsPlane( const CPlane &plane,
					const CRay &ray,
					CVector3<float> &vCollisionPoint )
{
  CVector3<float> vNormal;
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::RayIntersectsSphere( const CRay &ray,
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::PointInsideTriangle( const CVector3<float> & vPoint, const CVector3<float> & vVertex0,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::LineSegmentIntersectsTriangle( const Moose::Math::CLineSegment & line,
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::RayIntersectsTriangle( const Moose::Math::CRay & ray,
					   const Moose::Math::CVector3<float> & vVertex0,
					   const Moose::Math::CVector3<float> & vVertex1,
					   const Moose::Math::CVector3<float> & vVertex2,
					   float *pfDistance )
...
/////////////////////////////////////////////////////////////////
float
Moose::Collision::LineToLineDistanceSquared( const Moose::Math::CLine & line0, const Moose::Math::CLine & line1, float * pfS, float * pfT )
{
   ...
   if ( TOO_CLOSE_TO_ZERO(fDenominator) ) // parallel lines
   {
       ...
       if ( pfS ) *pfS = 0.0f;
       if ( pfT )  *pfT = 0.0f;
       return (line1.GetPosition()-line0.GetPosition()).LengthSqr();
   }
   else
   {
       ...
       SetColumnVector( mTmp, 1, line0.GetDirection());
...
/////////////////////////////////////////////////////////////////
float
Moose::Collision::LineSegmentToLineSegmentDistanceSquared( const Moose::Math::CLineSegment & line0, const Moose::Math::CLineSegment & line1, float *pfS, float * pfT )
{
    // Real-time- rendering, p. 618.
...
/////////////////////////////////////////////////////////////////
float
Moose::Collision::PointDistanceFromPlane( const CVector3<float> &vPoint, const CPlane & plane )
{
  CVector3<float> vNormal;
  vNormal.Set(const_cast<CPlane &>(plane).GetArray());
...
/////////////////////////////////////////////////////////////////
void
Moose::Collision::ClosestPointOnRay( const CVector3<float> &vPoint, const Moose::Math::CRay &ray, CVector3<float> & vClosestPoint )
{
...
/////////////////////////////////////////////////////////////////
void
Moose::Collision::ClosestPointOnLine( const CVector3<float> &vPoint, const Moose::Math::CLine &line, CVector3<float> & vClosestPoint )
{
  vClosestPoint = line.GetPosition() + (line.GetDirection() * (line.GetDirection().Dot(vPoint - line.GetPosition())) );
}
/////////////////////////////////////////////////////////////////
void
Moose::Collision::ClosestPointOnLineSegment( const CVector3<float> &vPoint, const Moose::Math::CLineSegment & line, CVector3<float> & vClosestPoint )
{
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::TriangleIntersectsOBB( CVector3<float> vVertex0,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::PlaneIntersectsBox( const CPlane &plane,
					const COrientedBox &box )
{
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::PointIntersectsOBB( const CVector3<float> &vPoint,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::CollisionPoint3Planes( const Moose::Math::CPlane & plane1,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::SphereIntersectsPlane( const Moose::Math::CPlane &plane,
					   const Moose::Volume::CSphere &sphere,
					   float &fCenterDistance)
{

  CVector3<float> vNormal;
  vNormal.Set(const_cast<Moose::Math::CPlane &>(plane).GetArray());
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::SphereIntersectsAACube( const CSphere &sphere,
...
/////////////////////////////////////////////////////////////////
int
Moose::Collision::SphereIntersectsSphere( const Moose::Volume::CSphere &sphereOne, const Moose::Volume::CSphere &sphereTwo )
{
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::SphereIntersectsCapsule( const Moose::Volume::CSphere & sphere, const Moose::Volume::CCapsule & capsule )
{
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::OBBIntersectsCapsule( const Moose::Volume::COrientedBox & box, const Moose::Volume::CCapsule & capsule )
{
  CVector3<float> vPointOnSegment;
...
/////////////////////////////////////////////////////////////////
void
Moose::Collision::CalculateDecalMesh( const CDecalVolume & decalVolume,
					...
					std::list< std::list< Moose::Math::CVector3<float> > > & lstTriangleFans )
{
  ...
  if ( indices.IsShortIndices())
  {
    ...
    for( size_t i=0;i<indices.GetNumIndices();i+=3)
    {
      ...
      std::list<Moose::Math::CPlane>::iterator it;
    ...
    std::list< std::list< Moose::Math::CVector3<float> > >::iterator fan_iterator;
    ...
    for( fan_iterator  = lstTriangleFans.begin();
	 ...
	 fan_iterator++)
    {
      std::vector<Moose::Math::CPlane>::const_iterator plane_it;
					...
					std::list< std::list< Moose::Spatial::CVertex > > & lstTriangleFans )
{
  ...
  if ( indices.IsShortIndices())
  {
    ...
    // Do actual clipping against planes.
    std::list< std::list< Moose::Spatial::CVertex > >::iterator fan_iterator;
    std::list< Moose::Spatial::CVertex >::iterator v_iterator;
...
/////////////////////////////////////////////////////////////////
void
Moose::Collision::ClipPolygon( const Moose::Math::CPlane & plane, std::list< Moose::Math::CVector3<float> > & lstVertices )
{

  const int POS_SIDE =  1;
  const int NEG_SIDE =  -1;

  std::list< Moose::Math::CVector3<float> > lstVerticesNew;


  if ( lstVertices.size() < 3 ) return;

  // Determine side of first vertex in respect to plane
  std::list< Moose::Math::CVector3<float> >::iterator it;
...
/////////////////////////////////////////////////////////////////
void
Moose::Collision::ClipPolygon( const Moose::Math::CPlane & plane, std::list< Moose::Spatial::CVertex > & lstVertices )
{

  const int POS_SIDE =  1;
  const int NEG_SIDE =  -1;

  std::list< Moose::Spatial::CVertex > lstVerticesNew;


  if ( lstVertices.size() < 3 ) return;

  // Determine side of first vertex in respect to plane
  std::list< Moose::Spatial::CVertex >::iterator it;
  it = lstVertices.begin();
...
Moose::Collision::OBBIntersectsPolytope( const COrientedBox & obBox, const Moose::Volume::CPolytope & poly )
{
  ...
  if ( bUseLineSegmentTest )
  {
    ...
    std::vector<Moose::Math::CPlane>::const_iterator planeIt;
...
/////////////////////////////////////////////////////////////////
VOLUME_INTERSECTION
Moose::Collision::CapsuleIntersectsPolytope( const CCapsule &capsule, const Moose::Volume::CPolytope & poly )
{
    int iType;
    ...
    for( planeIt = poly.GetPlanes().begin();planeIt != poly.GetPlanes().end(); planeIt++ )
    {
        if ( (iType = Moose::Collision::CapsuleIntersectsPlane( *planeIt, capsule )) == -1 ) return OUTSIDE;
...
/////////////////////////////////////////////////////////////////
VOLUME_INTERSECTION
Moose::Collision::SphereIntersectsPolytope( const CSphere &sphere, const Moose::Volume::CPolytope & poly )
{
  float fDistance = 0.0f;
  int iType;
  ...
  for( planeIt = poly.GetPlanes().begin();planeIt != poly.GetPlanes().end(); planeIt++ )
  {
    iType = Moose::Collision::SphereIntersectsPlane( *planeIt, sphere, fDistance);
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::RayIntersectsAACube( const CRay &ray, const CAxisAlignedCube &aaCube,  float *pfValue )
{
...
/////////////////////////////////////////////////////////////////
bool
Moose::Collision::SphereIntersectsCone( const Moose::Volume::CSphere &sphere, const Moose::Volume::CCone &cone )
{
  bool bRetval = 0;
...
///////////////////////////////////////////////////////////////////////////////
bool
Moose::Collision::OBBIntersectsOBB( const Moose::Volume::COrientedBox & box1, const Moose::Volume::COrientedBox & box2 )
{
...
///////////////////////////////////////////////////////////////////////////////
bool 
Moose::Collision::SphereIntersectsAABB( const Moose::Volume::CSphere &sphere, const Moose::Volume::CAxisAlignedBox &aabb)
{
    float fDistance = 0.0f;
  float fTmp = 0.0f;
  /////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
bool 
Moose::Collision::SphereIntersectsOBB( const Moose::Volume::CSphere &sphere, const Moose::Volume::COrientedBox & box )
{
