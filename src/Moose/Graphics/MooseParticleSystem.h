/////////////////////////////////////////////////////////////////
#ifndef __MooseParticleSystem_h__
#define __MooseParticleSystem_h__
/////////////////////////////////////////////////////////////////
...
namespace Moose 
{
  namespace Graphics
  {
    ...
    class MOOSE_API CParticleSystem 
    {
    private:
      /// Particle array
      ...
      Moose::Volume::CAxisAlignedBox m_BBox;
      /// Bounding sphere.
      Moose::Volume::CSphere	     m_BSphere;
    private:
      ////////////////////
    ...
    public:
      ...
      const Moose::Volume::CAxisAlignedBox & GetBoundingBox() const;
      ////////////////////
    ...
    class MOOSE_API CCompletePolicy
    {
    public:
      /// Size policy.
...
//     class MOOSE_API CMillisecondPolicyBase 
//     {
//     protected:
...
//     };
    ...
    class MOOSE_API CSecondPolicyBase
    {
    protected:
    ...
    class MOOSE_API CTimeStampPolicyBase
    {
    protected:
      /// Passed time in seconds
    ...
    public:
      ...
      /// Prepares this policy according to given time parameter.
      /// \param nPassedTimeInMS Passed milliseconds are stored as seconds.
      inline void Prepare( const Moose::Core::CTimeStamp & rPassedTime )
      {
	m_PassedTime = rPassedTime;
      ...
      /// Returns passed time.
      /// \returns Passed time.
      inline const Moose::Core::CTimeStamp & GetPassedTime() const
      {
	return m_PassedTime;
      }
    };
    ...
    class MOOSE_API CGravityAction : public CSecondPolicyBase
    {
    private:
      /// Gravity values.
      Moose::Math::CVector3<float> m_vGravity;
    public:
      ////////////////////
      /// Default constructor.
	...
	particle.m_vVelocity += m_vGravity * GetPassedTime();
      ...
      inline void SetGravity( const Moose::Math::CVector3<float> &vDir )
      {
	m_vGravity = vDir;
      }
    ...
    template <class PARTICLE_TYPE>
    class MOOSE_API CMoveAction : public CSecondPolicyBase
    {
    public:
      ////////////////////
      /// Modifies given particle.
    ...
    template <class PARTICLE_TYPE>
    class MOOSE_API CSizeInitializer
    {
    public:
      /// Size value.
      float m_fSize;
    ...
    /////////////////////////////////////////////////////////////////
    template <class PARTICLE_TYPE>
    class MOOSE_API CEnergyInitializer
    {
    public:
      /// Initial energy.
      float m_fEnergy;
    ...
    template <class PARTICLE_TYPE>
    class MOOSE_API CVelocityInitializer
    {
    public:
      /// Velocity vector.
      Moose::Math::CVector3<float> m_vVelocity ;
    ...
    template <class PARTICLE_TYPE>
    class MOOSE_API CColorInitializer
    {
    public:
      /// Color value.
      Moose::Math::CVector4<unsigned char> m_vColor;
...
/////////////////////////////////////////////////////////////////
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::CParticleSystem()
{
...
/////////////////////////////////////////////////////////////////
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
inline const Moose::Volume::CSphere & 
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetBoundingSphere() const
{
  return m_BSphere;
}
/////////////////////////////////////////////////////////////////
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
inline const Moose::Volume::CAxisAlignedBox & 
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetBoundingBox() const
{
  return m_BBox;
}
/////////////////////////////////////////////////////////////////
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
inline size_t  
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetMaxParticles() const
{
  return SIZE;
}
/////////////////////////////////////////////////////////////////
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
inline size_t  
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetAliveCount() const
{
...
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
void
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::DetermineBoundingVolume()
{
  if ( GetAliveCount() > 0 )
  {
    Moose::Math::CVector3<float> vMaxValues( m_aParticles[0].m_vPosition );
    Moose::Math::CVector3<float> vMinValues( m_aParticles[0].m_vPosition );
    Moose::Math::CVector3<float> vPos;
    Moose::Math::CVector3<float> vExtents;    
...
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
void
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::Update( float fSecondsPassed )
{
...
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetParticles() const
{
  return m_aParticles;
}
/////////////////////////////////////////////////////////////////
...
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::GetParticles() 
{
  return m_aParticles;
}
/////////////////////////////////////////////////////////////////
...
template <size_t SIZE, class InitializePolicy, class ActionPolicy, class PARTICLE_TYPE >
inline int 
Moose::Graphics::CParticleSystem<SIZE,InitializePolicy, ActionPolicy, PARTICLE_TYPE >::IsAlive() const
{
...
/*       virtual void		Init(const size_t &nNumParticles, const Moose::Math::CVector3<float> &vPosition) = 0; */
/*       /// Returns the number of particles alive. */
/*       virtual const size_t	GetAliveCount() const = 0; */
/*       /// Returns bounding sphere for this system. */
/*       virtual const Moose::Volume::CSphere & GetBoundingSphere() const = 0; */
/*       /// Returns Axis-aligned box for this system. */
/*       virtual const Moose::Volume::CAxisAlignedBox & GetBoundingBox() const = 0; */
/*     }; */
#endif
