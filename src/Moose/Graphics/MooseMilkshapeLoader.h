...
#ifndef __MooseMilkshapeLoader_h__
#define __MooseMilkshapeLoader_h__
/////////////////////////////////////////////////////////////////
...
#pragma pack()
    ...
    {
      bool operator()( const Moose::Spatial::CVertex & v1, const Moose::Spatial::CVertex & v2) const
      {
    ...
    typedef std::map<Moose::Spatial::CVertex, size_t, Moose::Data::MSVertexCompare> VertexIndexMap;
    /////////////////////////////////////////////////////////////////
    /// Actual model class, which encapsulates structs above.
    class MOOSE_API CMilkshapeLoader : public Moose::Data::CModelLoader
    {
    public:
      /// Vertex array size.
      WORD m_nNumVertices;
    ...
    public:
      ...
      Moose::Graphics::CVertexDescriptor * GetInterleavedArray( Moose::Graphics::ELEMENT_TYPE tType = Moose::Graphics::ELEMENT_TYPE_V3F_N3F_T2F) const;
    ...
    private:
      ...
      void CreateGroupIndexMap( std::vector<Moose::Spatial::CVertex> &vecVertices );
      ////////////////////
      ...
      void CreateTriangleList( std::vector<Moose::Spatial::CVertex> &vecVertices, std::vector<unsigned int> &vecIndices );
    };
    //////////////////////////////////////////////////////////////// 
  }; // namespace Data
}; // namespace Moose
