...
using namespace std;
/////////////////////////////////////////////////////////////////
Moose::Graphics::CTGAImage::CTGAImage()
{ 
...
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::Load(const string & szFilename)
{
  using namespace std;
  ifstream fIn;
  ...
  fIn.open(szFilename.c_str(),ios::binary);
...
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::ReadHeader() // Examine the header and populate our class attributes
{
...
///////////////////////////////////////////////////////////////// 
int 
Moose::Graphics::CTGAImage::LoadRawData() // Load uncompressed image data
{
  short iOffset;
...
///////////////////////////////////////////////////////////////// 
int Moose::Graphics::CTGAImage::LoadTgaRLEData() // Load RLE compressed image data
{
...
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::LoadTgaPalette() // Load a 256 color palette
{
  unsigned char bTemp;
...
/////////////////////////////////////////////////////////////////
void Moose::Graphics::CTGAImage::BGRtoRGB() // Convert BGR to RGB (or back again)
{
...
/////////////////////////////////////////////////////////////////
void 
Moose::Graphics::CTGAImage::FlipImg() // Flips the image vertically (Why store images upside down?)
{
  unsigned char bTemp;
...
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::GetBPP() 
{
  return iBPP;
}
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::GetWidth()
{
  return iWidth;
}
/////////////////////////////////////////////////////////////////
int 
Moose::Graphics::CTGAImage::GetHeight()
{
  return iHeight;
}
/////////////////////////////////////////////////////////////////
unsigned char * 
Moose::Graphics::CTGAImage::GetImg()
{
  return pImage;
}
/////////////////////////////////////////////////////////////////
unsigned char * 
Moose::Graphics::CTGAImage::GetPalette()
{
  return pPalette;
}
/////////////////////////////////////////////////////////////////
Moose::Graphics::CTGAImage * 
Moose::Graphics::CTGAImage::LoadTGAImage( const char *szFilename, std::ostream & stream )
{
