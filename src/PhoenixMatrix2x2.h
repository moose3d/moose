...
namespace Phoenix 
{
  namespace Math 
  {
    ...
    template<typename TYPE> int InverseMatrix( CMatrix2x2<TYPE> mOrig, CMatrix2x2<TYPE> &mInverse);
  } // namespace Math
} // namespace Phoenix
...
template<typename TYPE>
int
Phoenix::Math::InverseMatrix( CMatrix2x2<TYPE> mOrig, CMatrix2x2<TYPE> &mInverse)
{
#define MATRIX_NOT_INVERTIBLE 1
#define MATRIX_INVERTIBLE     0
