...
using namespace std;
/////////////////////////////////////////////////////////////////
Phoenix::Graphics::CTGAImage::CTGAImage()
{ 
...
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::Load(const string & szFilename)
{
  using namespace std;
  ifstream fIn;
...
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::ReadHeader() // Examine the header and populate our class attributes
{
...
///////////////////////////////////////////////////////////////// 
int 
Phoenix::Graphics::CTGAImage::LoadRawData() // Load uncompressed image data
{
  short iOffset;
...
///////////////////////////////////////////////////////////////// 
int Phoenix::Graphics::CTGAImage::LoadTgaRLEData() // Load RLE compressed image data
{
...
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::LoadTgaPalette() // Load a 256 color palette
{
  unsigned char bTemp;
...
/////////////////////////////////////////////////////////////////
void Phoenix::Graphics::CTGAImage::BGRtoRGB() // Convert BGR to RGB (or back again)
{
...
/////////////////////////////////////////////////////////////////
void 
Phoenix::Graphics::CTGAImage::FlipImg() // Flips the image vertically (Why store images upside down?)
{
  unsigned char bTemp;
...
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::GetBPP() 
{
  return iBPP;
}
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::GetWidth()
{
  return iWidth;
}
/////////////////////////////////////////////////////////////////
int 
Phoenix::Graphics::CTGAImage::GetHeight()
{
  return iHeight;
}
/////////////////////////////////////////////////////////////////
unsigned char * 
Phoenix::Graphics::CTGAImage::GetImg()
{
  return pImage;
}
/////////////////////////////////////////////////////////////////
unsigned char * 
Phoenix::Graphics::CTGAImage::GetPalette()
{
  return pPalette;
}
/////////////////////////////////////////////////////////////////
