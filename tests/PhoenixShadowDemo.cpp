...
int main()
{
  ...
  CModel *pModel    = Phoenix::Data::LoadMilkshapeModel( "Resources/Models/shadowscene.ms3d",    "shadowmodel");

  COglTexture *pTextureWall = pRenderer->CreateTexture( "./Resources/Textures/wall.tga");
  assert( pTextureWall  != NULL );

  CModel *pBackdrop = Phoenix::Data::LoadMilkshapeModel( "Resources/Models/shadowbackdrop.ms3d", "shadowbackdrop");
